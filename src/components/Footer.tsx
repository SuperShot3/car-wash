  ...
  return (
    <footer className="bg-zinc-900 text-white py-20">
      <div className="container-custom">
        {/* Верхняя секция с логотипом и соц. сетями */}
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div className="flex flex-col items-center md:items-start space-y-4 mb-8 md:mb-0">
            ...
            <p className="text-zinc-400">Premium Car Care Services</p>
          </div>

          {/* Социальные сети */}
          <div className="flex items-center space-x-8">
            <a 
              href="https://facebook.com/carwash" 
              target="_blank" 
            ...
            <a 
              href="https://instagram.com/carwash" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-zinc-400 hover:text-gold transition-colors"
        ...
        <div className="pt-8 border-t border-zinc-800 text-center text-zinc-400">
          <p>&copy; {new Date().getFullYear()} Car Spa. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
